...
remote func on_spawn_projectile(position: Vector2, direction: Vector2, projectileType: String, projectileId: String, knockbackFactor : float):
	.on_spawn_projectile(position, direction, projectileType, projectileId, knockbackFactor)
